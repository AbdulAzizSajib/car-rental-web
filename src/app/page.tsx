...
import { carsData } from "@/src/lib/car-data";
...
const categories = [
  {
    ...
    count: 14,
    image:
      "https://images.unsplash.com/photo-1606611013016-969c19d24e23?w=600&h=400&fit=crop",
  },
  {
    name: "SUV",
    count: 9,
    image:
      "https://images.unsplash.com/photo-1605559424843-9e4c3ff86173?w=600&h=400&fit=crop",
  },
  {
    name: "Hatchback",
    count: 7,
    image:
      "https://images.unsplash.com/photo-1619405399517-541782920ee0?w=600&h=400&fit=crop",
  },
  {
    name: "Crossover",
    count: 6,
...
const howItWorks = [
  {
    ...
    title: "Find a Car",
    description:
      "Filter from 48+ premium cars by body type, fuel, transmission, and budget.",
  },
  {
    icon: Calendar,
    title: "Pick Your Time",
    description:
      "Choose hourly, daily, or weekly rental. Free cancellation up to 30 minutes before pickup.",
  },
  {
    icon: Zap,
    title: "Drive Now",
    description:
      "Unlock the car from your phone, hit the road, and return it anywhere in the network.",
  },
];
      ...
      <section className="relative w-full min-h-screen overflow-hidden flex items-center">
        ...
        <div className="relative z-10 pl-12 pr-6 py-20 w-full max-w-2xl">
          ...
          >
            Drive More,
            <br />
            Spend <span style={{ color: "#c9a84c" }}>Less</span>
            <br />
            Every Time
          </h1>
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col">
                <span
                  className="text-[10px] tracking-[.08em] uppercase mb-0.5"
          ...
          <div className="flex items-end justify-between mb-10">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                />
                <p
                  className="text-[11px] uppercase tracking-[.18em] font-semibold"
                  style={{ color: "#c9a84c" }}
                >
                  Browse by Type
                </p>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between">
                  <div>
                    <p className="font-['Bebas_Neue'] text-lg text-white tracking-wide leading-none">
                      {cat.name}
                    </p>
                  ...
                  <div
                    className="w-7 h-7 rounded-sm flex items-center justify-center transition-all group-hover:scale-110"
            ...
            {popularCars.map((car) => (
              ...
              >
                ...
                <div className="flex items-center justify-between px-4 pt-3 pb-2 border-b border-gray-100">
                  ...
                  <Heart
                    size={14}
                    className="transition-colors group-hover:text-red-400 text-gray-300"
                  />
                </div>
                {/* Image */}
                ...
                <div
                  className="h-[3px] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"
                  style={{ background: "#c9a84c" }}
                />
              </Link>
            ))}
              ...
              return (
                <div
                  ...
                  style={{
                    background: "#fff",
                    border: "1px solid #ede8df",
                    boxShadow: "0 2px 8px rgba(201,168,76,0.05)",
                  }}
                >
                  {/* Step number watermark */}
                  <div
                    className="absolute top-4 right-5 font-['Bebas_Neue'] text-7xl leading-none select-none"
                  ...
                  <p
                    className="text-[10px] uppercase tracking-[.15em] mb-1.5 font-semibold"
                    style={{ color: "#c9a84c" }}
                  >
                    Step {i + 1}
                  </p>
                  ...
                  {/* Gold bottom sweep on hover */}
                  <div
                    className="absolute bottom-0 left-0 right-0 h-[3px] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded-b-lg"
                    style={{ background: "#c9a84c" }}
                  />
                </div>
              );
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 text-[11px] tracking-[.06em] text-gray-400">
            No credit card required · Free cancel 30 min before · Instant
            confirmation
          </p>
        </div>
      </section>
