    ...
    <div className="min-h-screen flex" style={{ background: "#ede8df" }}>
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=1200&h=900&fit=crop')",
          }}
        />
        ...
        {/* Gold left edge */}
        <div
          className="absolute left-0 top-0 w-0.75 h-full"
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md">
            ...
            <h2
              className="font-['Bebas_Neue'] text-white leading-[.92] tracking-[.01em] mb-6"
            ...
            >
              Access a curated fleet of premium vehicles. Instant unlock, full
              insurance, no hidden fees.
            </p>
          </div>
          ...
          {oauthError && !serverError && (
            <div className="mb-4 px-4 py-3 rounded-sm text-sm text-red-700 bg-red-50 border border-red-200">
              {oauthError === "oauth_failed"
                ...
                : oauthError === "no_user_found"
                  ? "No account found for this Google profile."
                  : oauthError === "no_session_found"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={(e) => {
                        field.handleBlur();
                        e.currentTarget.style.borderColor = field.state.meta
                          .errors.length
                          ? "#ef4444"
                          : "#d9d0c1";
                      }}
